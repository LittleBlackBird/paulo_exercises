...

  {
    ...
    translations: {
      en: {
        ...
        story: "Paulo borrowed his sister's favorite pen without asking, and it fell and broke. He hid it in a drawer and said nothing. But all afternoon, the secret sat on his chest like a heavy backpack he couldn't take off. His thoughts kept replaying the crack of the pen, and he couldn't enjoy his game. He learned something important: guilt is the heart's alarm, ringing until you make things right. So he took a deep breath, showed his sister the pen, said 'I'm sorry, I should have asked,' and offered his own savings to replace it. She was upset, then softened. The backpack came off. That heavy-secret feeling is guilty — and honesty is what unlocks it.",
      },
      pt: {
        name: "Culpado",
        definition: "Sentir-se mal por algo errado que você fez.",
        story: "Paulo pegou a caneta favorita da irmã sem pedir, e ela caiu e quebrou. Ele escondeu a caneta numa gaveta e não disse nada. Mas a tarde inteira o segredo ficou no peito como uma mochila pesada que não saía. Os pensamentos repetiam o barulho da caneta quebrando, e ele nem conseguiu curtir o jogo. Aprendeu algo importante: a culpa é o alarme do coração, tocando até você consertar as coisas. Então respirou fundo, mostrou a caneta para a irmã, disse 'Desculpa, eu devia ter pedido' e ofereceu as próprias economias para repor. Ela ficou chateada, depois amoleceu. A mochila saiu. Esse sentimento de segredo pesado é culpa — e a honestidade é a chave que o destrava.",
      },
      es: {
        name: "Culpable",
        definition: "Sentirse mal por algo malo que hiciste.",
        story: "Paulo tomó prestada la lapicera favorita de su hermana sin pedirla, y se cayó y se rompió. La escondió en un cajón y no dijo nada. Pero toda la tarde el secreto se quedó en su pecho como una mochila pesada que no podía quitarse. Sus pensamientos repetían el crujido de la lapicera, y no pudo disfrutar su juego. Aprendió algo importante: la culpa es la alarma del corazón, que suena hasta que arreglas las cosas. Así que respiró hondo, le mostró la lapicera a su hermana, dijo 'Perdón, debí pedirla' y ofreció sus ahorros para reponerla. Ella se enojó, luego se ablandó. La mochila se cayó. Ese sentimiento de secreto pesado es culpa — y la honestidad es la llave.",
      },
    },
  },
...

  {
    ...
    translations: {
      en: {
        ...
        story: "A big storm rattled the windows that night, but Paulo was wrapped in his favorite blanket on the couch, squeezed between his mom and dad, with hot cocoa steaming in his hands. Outside, the wind howled and the rain drummed hard, but inside, the lamp glowed yellow and warm. Paulo noticed something interesting: the storm was still scary, but his body wasn't scared. His muscles were soft, his breathing was easy, and his mind knew, without any doubt, that the people around him would take care of him. The thunder became just a sound, like a giant clearing his throat far away. That protected, soft-muscles, nothing-can-hurt-me-here feeling is safe.",
      },
      pt: {
        name: "Seguro",
        definition: "Sentir-se protegido, sem nada a temer agora.",
        story: "Uma tempestade grande sacudia as janelas naquela noite, mas Paulo estava enrolado na coberta favorita no sofá, espremido entre a mãe e o pai, com um chocolate quente soltando fumaça nas mãos. Lá fora, o vento uivava e a chuva batucava forte, mas dentro, o abajur brilhava amarelo e quente. Paulo percebeu algo interessante: a tempestade continuava assustadora, mas o corpo dele não estava assustado. Os músculos estavam macios, a respiração leve, e a mente sabia, sem dúvida nenhuma, que as pessoas ao redor cuidariam dele. O trovão virou só um som, como um gigante limpando a garganta bem longe. Esse sentimento protegido, de músculos macios, é segurança.",
      },
      es: {
        name: "Seguro",
        definition: "Sentirse protegido, sin nada que temer ahora.",
        story: "Una gran tormenta sacudía las ventanas esa noche, pero Paulo estaba envuelto en su manta favorita en el sofá, apretado entre su mamá y su papá, con un chocolate caliente humeando en sus manos. Afuera, el viento aullaba y la lluvia tamborileaba fuerte, pero adentro, la lámpara brillaba amarilla y cálida. Paulo notó algo interesante: la tormenta seguía dando miedo, pero su cuerpo no tenía miedo. Sus músculos estaban blandos, su respiración era fácil, y su mente sabía, sin ninguna duda, que las personas a su alrededor lo cuidarían. El trueno se volvió solo un sonido lejano. Ese sentimiento protegido es seguridad.",
      },
    },
  },
